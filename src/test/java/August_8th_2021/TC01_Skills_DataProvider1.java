...
public class TC01_Skills_DataProvider1 {
	...
	//String SkillName="Java12",SkillDescr="Java12 descr";
	 ...
	 @DataProvider(name = "Orange2")
	  public static Object[][] Test1() throws Exception {
	        ...
	        return new Object[][] { 
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Java45","Java45 descr" },
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Java46","Java46 descr" },
	        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Java47","Java47 descr" }
	        	};
	  }
	...
	public void loginTest(String TestURL,String UserName,String Password,String SkillName,String SkillDescr) throws Exception
	{
		...
		TC01_Skills_DataProvider1 T1 = new TC01_Skills_DataProvider1();
